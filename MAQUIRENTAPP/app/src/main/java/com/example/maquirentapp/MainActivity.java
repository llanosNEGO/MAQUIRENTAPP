...
//        });
        ...
        navController.addOnDestinationChangedListener((ctrl, dest, args) -> {
            ...
            } else if (dest.getId() == R.id.nav_rent) {
                setHeaderTitle("CGE");
                setHeaderIcon(R.drawable.icon_generador);
            } else if (dest.getId() == R.id.nav_perfil) {
        ...
        LinearLayout navRent = findViewById(R.id.nav_rent);
        LinearLayout navPerfil = findViewById(R.id.nav_perfil);

        navHome.setOnClickListener(v -> navController.navigate(R.id.homeFragment));
        navRent.setOnClickListener(v -> navController.navigate(R.id.cgeFragment));
        navPerfil.setOnClickListener(v -> navController.navigate(R.id.perfilFragment));
...
//    }
    ...
    protected int getContentLayoutId() {
        return R.layout.ly_base_activity;
    }
}